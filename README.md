...
## Model
- AppState - модель данных страницы в целом, наследует Model содержит поля и методы:
  ...
  - order - данные заказа;
    ...
    - phone - телефон;
    - address - адрес;
    - items - id товаров в корзине;
    - total - стоимость заказа;
  - preview - превью карточки, ее id;
  - formErrors - ошибки валидации; 
  - getTotal - метод получения стоимости заказа;
  - getCartItems - метод получения товаров из корзины;
  - addItemToCart - метод добавления товара в корзину;
  - deleteItemFromCart - метод удаления товара из корзины;
  - clearCart - метод очистки корзины;
  - clearOrder - метод очистки массива товаров в заказе;
  - setCatalog - метод установки каталога товаров;
  - setPreview - метод установки превью карточки;
  - setOrderField - метод установки значений полей ввода формы;
  - setOrderTotal - метод установки стоимости для заказа;
  - setOrderItems - метод установки товаров для заказа;
...
- класс CardView - карточка товара, наследует Component, содержит поля и методы:
  ...
  - setIndex - метод установки индекса товара в корзине;
  ...
  - render - рендер карточки с проверкой для блока кнопки 'в корзину';
...
- класс SuccessView - успешное оформление заказа, наследует Component, содержит содержит поля и методы:
  ...
  - _total - отображение стоимости заказа;
  - total - сеттер для стоимости;
...
- cart:open - открыта корзина;
- card:select - открытие карточка товара;
- order:open - открыта форма заказа с методом оплаты и адресом;
- form:open - открыта форма заказа с почтой и телефоном;
